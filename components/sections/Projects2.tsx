      ...
      <div className="container">
        <div className="rounded-3 border border-1 position-relative overflow-hidden">
          <div className="box-linear-animation position-relative z-1">
                      ...
                      <div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                        <div className="row">
                          <div className="col-lg-5">
                            <img className="w-100" src={project.imgSrc} alt={`Project ${index + 1}`} />
                          </div>
                          <div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                            ...
                            <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
                              <Link href={project.WebSiteLink} className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
            ...
            <img className="position-absolute top-50 start-50 translate-middle z-0 img-shape-2" src="assets/imgs/home-page-2/shape-2.svg" alt="shape" />
          </div>
        </div>
      </div>
    </div>
